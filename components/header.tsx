                       ...
                       <div className="menu-main-menu-container">
                          <ul className="menu nav-menu lg:flex lg:items-center lg:gap-1 xl:gap-2">
                             ...
                             <li className="menu-item lg:inline-flex lg:items-center menu-item-has-children group">
                                ...
                                <div id="DigitalParticipationHover" className="submenu hidden z-10 lg:py-4 xl:py-5 2xl:py-6 rounded-bordered">
                             ...
                             <li className="menu-item relative lg:inline-flex lg:items-center menu-item-has-children group">
                                ...
                                <div id="AboutHover" className="submenu hidden z-10 lg:py-4 xl:py-5 2xl:py-6 rounded-bordered">
                             ...
                             <li className="menu-item relative lg:inline-flex lg:items-center menu-item-has-children group">
                                ...
                                <div id="MoreHover" className="submenu hidden z-10 lg:py-4 xl:py-5 2xl:py-6 rounded-bordered">
